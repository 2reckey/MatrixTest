...
//        };
        ...
        if (duration1 < duration2) {
            System.out.println("Функция вычисления обратной матрицы с помощью миноров быстрее функции вычисления обратной матрицы с помощью метода Гаусса");
        } else {
            System.out.printf("Функция вычисления обратной матрицы с помощью метода Гаусса в %.3f раз быстрее функции вычисления обратной матрицы с помощью миноров\n", div);
        }
